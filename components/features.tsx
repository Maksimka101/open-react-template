          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M16 18L22 18" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M19 22H22" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="19" cy="19" r="19" fill="#5D5FEF" />
                <circle cx="19" cy="16" r="1.5" stroke="white" strokeLinecap="round" />
                ...
                <path d="M19 19.5C21.3642 19.5 22.1314 21.3251 22.3804 22.5097C22.494 23.0501 22.0523 23.5 21.5 23.5H16.5C15.9477 23.5 15.506 23.0501 15.6196 22.5097C15.8686 21.3251 16.6358 19.5 19 19.5Z" stroke="white" strokeLinecap="round" />
                <path d="M25.5 28.5H27C27.8284 28.5 28.5 27.8284 28.5 27V25.5" stroke="white" strokeLinecap="round" />
                <path d="M25.5 9.5H27C27.8284 9.5 28.5 10.1716 28.5 11V12.5" stroke="white" strokeLinecap="round" />
                <path d="M12.5 28.5H11C10.1716 28.5 9.5 27.8284 9.5 27V25.5" stroke="white" strokeLinecap="round" />
                <path d="M12.5 9.5H11C10.1716 9.5 9.5 10.1716 9.5 11V12.5" stroke="white" strokeLinecap="round" />
              </svg>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="19" cy="19" r="19" fill="#5D5FEF" />
                <circle cx="19" cy="19" r="9.5" stroke="white" strokeLinecap="round" />
                <circle cx="16" cy="17" r="1" fill="white" stroke="white" strokeLinecap="round" />
                <circle cx="22" cy="17" r="1" fill="white" stroke="white" strokeLinecap="round" />
                <path fillRule="evenodd" clipRule="evenodd" d="M15.6289 22C15.3491 22 15.2092 22 15.1346 22.1068C15.0599 22.2136 15.1032 22.3318 15.1897 22.5683C15.7059 23.9788 17.2166 25 19 25C20.7833 25 22.2941 23.9788 22.8102 22.5683C22.8968 22.3318 22.94 22.2136 22.8654 22.1068C22.7908 22 22.6509 22 22.3711 22H15.6289Z" fill="white" />
              </svg>
