      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center ">
            ...
            {/* Copyrights note */}
            <div className="md:grow text-gray-400 text-sm mr-4">
              &copy; teamin.pro. All rights most likely reserved.
            </div>

            <Link href="https://teamin.pro/docs/privacy-policy.html"
              className="flex text-sm text-gray-400 hover:text-gray-100">
              Privacy policy
            </Link>
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li className="ml-4">
                <Link href="https://github.com/teamin-pro" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
